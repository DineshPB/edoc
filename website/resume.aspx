<%@ Page Language="VB" AutoEventWireup="false" CodeFile="resume.aspx.vb" Inherits="website_resume" %>
    ...
    <div class="container body">
        <div class="main_container">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">
                                            Work Expereince:<span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <asp:TextBox ID="txtworkexpereince" runat="server" required="required" class="form-control col-md-7 col-xs-12"
                                                TextMode="MultiLine"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="form-group">
          ...
          <div class="pull-right">
            <a href="login.aspx">E-Document Creator</a>
          </div>
