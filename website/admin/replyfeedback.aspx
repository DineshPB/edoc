<%@ Page Title="" Language="VB" MasterPageFile="~/website/admin/AdminMasterPage.master" AutoEventWireup="false" CodeFile="replyfeedback.aspx.vb" Inherits="website_admin_replyfeedback" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <%  
        ...
        If Not Session("auserid") Is Nothing Then
            ...
            cmd.CommandText = "Select * from [suggest_master] Where fromid='" + sid + "' OR toid= '" + sid + "' order by date ASC"
