<%@ Page Language="VB" AutoEventWireup="false" CodeFile="informaldata.aspx.vb" Inherits="website_letter_informaldata" %>
...
<body style="height: 842px; width: 928px; /* to centre page on screen*/
    ...
    <div id="toinfo" align="left">
        <h1>
        <asp:Label ID="as" runat="server" Text="InFormal"></asp:Label>
