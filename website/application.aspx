<%@ Page Language="VB" AutoEventWireup="false" CodeFile="application.aspx.vb" Inherits="website_application" %>
                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <asp:TextBox ID="txtdate" runat="server" required="required" class="form-control col-md-7 col-xs-12"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <asp:TextBox ID="txtfirstpara" runat="server" required="required" class="form-control col-md-7 col-xs-12"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <asp:TextBox ID="txtsecondpara" runat="server" required="required" class="form-control col-md-7 col-xs-12"
                                                TextMode="MultiLine"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <asp:TextBox ID="txtthirdpara" runat="server" class="form-control col-md-7 col-xs-12"
                                                TextMode="MultiLine"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="ln_solid">
