<%@ Page Language="VB" AutoEventWireup="false" CodeFile="cv.aspx.vb" Inherits="website_cv" %>
                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <asp:TextBox ID="txtwebsite" runat="server" required="required" 
                                                class="form-control col-md-7 col-xs-12" TextMode="SingleLine" ></asp:TextBox>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <asp:TextBox ID="txteducation" runat="server" required="required" 
                                                class="form-control col-md-7 col-xs-12" TextMode="MultiLine" ></asp:TextBox>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" 
                                                ErrorMessage="*Please Enter Education" ForeColor="Red" 
                                                ControlToValidate="txteducation"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <asp:TextBox ID="txtqualification" runat="server" required="required" 
                                                class="form-control col-md-7 col-xs-12" TextMode="MultiLine" ></asp:TextBox>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" 
                                                ErrorMessage="*Please Enter Qualification" ForeColor="Red" 
                                                ControlToValidate="txtqualification"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <asp:TextBox ID="txtInterest" runat="server" required="required" 
                                                class="form-control col-md-7 col-xs-12" TextMode="MultiLine" ></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <asp:TextBox ID="txtreference" runat="server" required="required" 
                                                class="form-control col-md-7 col-xs-12" TextMode="SingleLine" ></asp:TextBox>
                                        </div>
                                    </div>
