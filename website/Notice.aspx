<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Notice.aspx.vb" Inherits="website_Notice" %>
...
<body class="login">
    <div class="container body">
        <div class="main_container">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>
                                        E-Document Notice <br /><br /><small> Fill up  given below information to create your Notice!</small></h2>
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <asp:TextBox ID="txtsender" runat="server" required="required" 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <asp:TextBox ID="txtfirstpara" runat="server" required="required" 
                                                class="form-control col-md-7 col-xs-12" TextMode="MultiLine" ></asp:TextBox>
                                        </div>
                                    </div>
                                         <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <asp:TextBox ID="txtsecondpara" runat="server" required="required" 
                                                class="form-control col-md-7 col-xs-12" TextMode="MultiLine" ></asp:TextBox>
                                        </div>
                                    </div>  
                                         <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <asp:TextBox ID="txtthirdpara" runat="server" required="required" 
                                                class="form-control col-md-7 col-xs-12" TextMode="MultiLine" ></asp:TextBox>
                                        </div>
                                    </div>
          ...
          E-Document Generator <a href="https://colorlib.com">Colorlib</a>
          </div>
