...
Partial Class website_content_page_resumecontent
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        If Not Session("userid") Is Nothing Then
            ...
            cmd.CommandText = "Insert into [cvresume_master] (Userid,fullname,emailid,contactnumber,website,address,education,qualification,workexp,specialskills,reference,profile,type) values ('" & Convert.ToInt32(Session("Userid")) & "','" & txtfullname.Text & "','" & txtemailid.Text & "'," & txtcontactno.Text & ",'" & txtwebsite.Text & "','" & txtaddress.Text & "','" & txteducation.Text & "','" & txtqualification.Text & "','" & txtworkexpereince.Text & "','" & txtInterest.Text & "','" & txtreference.Text & "','" & uprofile.Text & "','" + type + "')"
            cmd.ExecuteNonQuery()
        ...
        Else
            ...
            'cookie.Values.Add("reference", "referenceasdfasdasdasda")
            'Dim workexp = New EncryptDecrypt().Encrypt(txtworkexpereince.Text, "123456")
            'Dim reference = New EncryptDecrypt().Encrypt(txtreference.Text, "123456")
            'Dim qualification = New EncryptDecrypt().Encrypt(txtqualification.Text, "123456")
            'Dim interests = New EncryptDecrypt().Encrypt(txtInterest.Text, "123456")
            'Dim profile = New EncryptDecrypt().Encrypt(uprofile.Text, "123456")
            'cookie.Values.Add("workexp", workexp)
            ...
            Dim tsMinute As New TimeSpan(0, 0, 10, 0)
            ...
            Response.Redirect("~/website/resume/resumetemp.aspx")
