...
Partial Class website_content_page_letterdisplay
    ...
    Protected Sub wordbtn_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles wordbtn.Click
        Dim letterid As String
        letterid = Request.QueryString("letterid")
        Response.Redirect("~/website/content page/worddoc/letter.aspx?letterid=" & letterid)
    End Sub

    Protected Sub pdfbtn_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles pdfbtn.Click
        Dim letterid As String
        letterid = Request.QueryString("letterid")
        Response.Redirect("~/website/content page/pdf/letterpdf.aspx?letterid=" & letterid)
    End Sub
End Class
