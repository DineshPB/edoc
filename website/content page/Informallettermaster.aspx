<%@ Page Title="" Language="VB" MasterPageFile="~/website/content page/MasterPage.master" AutoEventWireup="false"
    CodeFile="Informallettermaster.aspx.vb" Inherits="website_Informallettermaster" %>
                ...
                <div class="x_content">
                    ...
                    <div id="form2" class="form-horizontal form-label-left">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7 col-sm-7 col-xs-12">
                                ...
                                <%--<asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" CssClass="changecolor"
                                    ControlToValidate="name" ForeColor="Red" Display="Dynamic" ErrorMessage="Please enter valid first name"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7 col-sm-7 col-xs-12">
                                <asp:TextBox ID="contactno" runat="server" required="required" class="form-control col-md-7 col-xs-12"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">
