...
Partial Class website_content_page_noticedatadisplayf
    ...
    Protected Sub wordbtn_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles wordbtn.Click
        Dim noticeid As String
        noticeid = Request.QueryString("noticeid")
        Response.Redirect("~/website/content page/worddoc/notice.aspx?noticeid=" & noticeid)
    End Sub

    Protected Sub pdfbtn_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles pdfbtn.Click
        Dim noticeid As String
        noticeid = Request.QueryString("noticeid")
        Response.Redirect("~/website/content page/pdf/noticepdf.aspx?noticeid=" & noticeid)
    End Sub
End Class
